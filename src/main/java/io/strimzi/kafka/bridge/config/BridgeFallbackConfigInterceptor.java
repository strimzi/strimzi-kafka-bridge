 ...
 * compatible with Quarkus and adding the key in the Map(s) of the {@link io.strimzi.kafka.bridge.config.KafkaConfig}.
 ...
 * For example, kafka."foo.bar" is the key in the Map of the {@link io.strimzi.kafka.bridge.config.KafkaConfig} but
