...
* Dependency updates (Kafka 4.1.1, Vert.x 5.0.7, Netty 4.2.9.Final, JMX Prometheus collector 1.5.0, OAuth 0.17.1, Kubernetes Configuration Provider 1.2.2, Metrics Reporter 0.3.0).
