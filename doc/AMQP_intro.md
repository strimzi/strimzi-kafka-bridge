...
This section describe how AMQP 1.0 based clients are able to connect to an Apache Kafka cluster in order to send and receive messages in terms of AMQP semantics.
